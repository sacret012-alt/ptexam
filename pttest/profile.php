...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-8">
                <h2>Константинов Александр, студент 3 курса информационной безопасности!<br>
                    Опоздал с выполнением задач на полгода!</h2>
            </div>
            <div class="col-4">
                <div class="row photo"></div>
                <div class="row"><p class="title_photo">Философ поколения</p></div>
            </div>
        </div>
    </div>
    <div class="container">
